...
import com.point18.slg2d.common.zkdomain.v2.*
...
class UpdateZkDataTo2 : UpdateZkData {
    ...
    override fun update() {
        ...
        processes.forEach { eachProcess ->
            ...
            eachProcess.seedNode = 0 // 新增字段，默认0
            mpm.dao.createOrUpdateData(
    ...
    private fun findAllProcesses(type: Int? = null): MutableList<ServerProcess> {
