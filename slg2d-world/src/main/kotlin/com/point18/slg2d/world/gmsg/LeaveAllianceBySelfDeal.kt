...
class LeaveAllianceBySelfDeal : Home2WorldTellDealBase() {
    override fun dealHomeTell(areaCache: AreaCache, worldId: Long, playerId: Long, msg: Home2WorldTell) {
        val tell = msg.leaveAllianceBySelfTell
        val oldPos = LinkedList<Int>(tell.oldPosList)
        ...
        playerLeaveAlliance(areaCache, player, session, player.allianceId, oldPos)
    }
}
