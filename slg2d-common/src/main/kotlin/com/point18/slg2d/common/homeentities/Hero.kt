...
const val HERO_NAMED_QUERY = "findHeroByPlayerId"

@NamedQueries(
    NamedQuery(
        name = HERO_NAMED_QUERY,
        // language=HQL
        query = "from HeroEntity where playerId = :playerId"
    )
)
...
data class HeroEntity(
    ...
    override fun primaryKey() = HeroPK(playerId, id)
}
