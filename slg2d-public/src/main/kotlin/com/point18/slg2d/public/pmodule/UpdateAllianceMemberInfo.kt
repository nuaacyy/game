...
class UpdateAllianceMemberInfoSyncOp : World2PublicAskDealBase() {
    ...
    fun dealMsg(
        ...
        allianceId: Long,
        playerId: Long,
        req: UpdateAllianceMemberInfoAskReq
    ): UpdateAllianceMemberInfoAskRt.Builder {
        val rt = newUpdateAllianceMemberInfoAskRtBuilder()
            ...
            when (updateType) {
                ...
                UpdateOnlineState -> {
                    ...
                    if (state == OffType) {
                        ...
                        // 玩家上线,推送给玩家上线所需的帮派数据
                        playerOnlineNotic(
                            publicCache.publicActor, allianceMember.mapPltAreaId, allianceMember.id,
    ...
    private fun enterGamePublicInfo(publicCache: PublicCache, player: AllianceMember): EnterGamePublicRtVo {
        ...
        if (player.allianceId != 0L) {
            ...
            markRedPoint.redPointType = constg.AllianceMarkRedPoint
            ...
            joinRedPoint.redPointType = constg.AllianceJoingRedPoint
            ...
            helpRedPoint.redPointType = constg.AllianceHelpRedPoint
    ...
    fun newUpdateAllianceMemberInfoAskRtBuilder(): UpdateAllianceMemberInfoAskRt.Builder {
        val rt = UpdateAllianceMemberInfoAskRt.newBuilder()
