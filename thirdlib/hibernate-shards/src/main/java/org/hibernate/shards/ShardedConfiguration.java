...
public class ShardedConfiguration {
     ...
     */
    protected void populatePrototypeWithVariableProperties(final ShardConfiguration config) {
     ...
     * value is not null.
     */
    protected static void safeSet(final Configuration config, final String key, final String value) {
        if (value != null) {
