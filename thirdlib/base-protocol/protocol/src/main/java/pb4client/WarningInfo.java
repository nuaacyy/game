...
/**
 * Protobuf type {@code client2server.WarningInfo}
 */
public  final class WarningInfo extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:client2server.WarningInfo)
  ...
  private WarningInfo() {
    warningForceInfos_ = java.util.Collections.emptyList();
    warningStartX_ = 0;
    warningStartY_ = 0;
    warningGotoX_ = 0;
    warningGotoY_ = 0;
  ...
  private WarningInfo(
    ...
    try {
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              warningForceInfos_ = new java.util.ArrayList<pb4client.WalkForceInfo>();
              mutable_bitField0_ |= 0x00000001;
            }
            warningForceInfos_.add(
      ...
      if (((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
        warningForceInfos_ = java.util.Collections.unmodifiableList(warningForceInfos_);
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return pb4client.War2GamePkt.internal_static_client2server_WarningInfo_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return pb4client.War2GamePkt.internal_static_client2server_WarningInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            pb4client.WarningInfo.class, pb4client.WarningInfo.Builder.class);
  }

  private int bitField0_;
  public static final int WARNINGFORCEINFOS_FIELD_NUMBER = 1;
  private java.util.List<pb4client.WalkForceInfo> warningForceInfos_;
  /**
   * <pre>
   * 进攻者ID
   * </pre>
   *
   * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
   */
  public java.util.List<pb4client.WalkForceInfo> getWarningForceInfosList() {
    return warningForceInfos_;
  }
  /**
   * <pre>
   * 进攻者ID
  ...
  public java.util.List<? extends pb4client.WalkForceInfoOrBuilder> 
      getWarningForceInfosOrBuilderList() {
    return warningForceInfos_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
   */
  public int getWarningForceInfosCount() {
    return warningForceInfos_.size();
  }
  /**
   * <pre>
   * 进攻者ID
   ...
   * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
   */
  public pb4client.WalkForceInfo getWarningForceInfos(int index) {
    return warningForceInfos_.get(index);
  }
  /**
   * <pre>
   * 进攻者ID
   ...
   * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
   */
  public pb4client.WalkForceInfoOrBuilder getWarningForceInfosOrBuilder(
      int index) {
    return warningForceInfos_.get(index);
  }
  ...
  public final boolean isInitialized() {
    ...
    for (int i = 0; i < getWarningForceInfosCount(); i++) {
      if (!getWarningForceInfos(i).isInitialized()) {
        memoizedIsInitialized = 0;
        return false;
      }
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < warningForceInfos_.size(); i++) {
      output.writeMessage(1, warningForceInfos_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < warningForceInfos_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, warningForceInfos_.get(i));
    }
    if (((bitField0_ & 0x00000001) == 0x00000001)) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof pb4client.WarningInfo)) {
      return super.equals(obj);
    }
    pb4client.WarningInfo other = (pb4client.WarningInfo) obj;

    boolean result = true;
    result = result && getWarningForceInfosList()
        .equals(other.getWarningForceInfosList());
  ...
  public int hashCode() {
    ...
    if (getWarningForceInfosCount() > 0) {
      hash = (37 * hash) + WARNINGFORCEINFOS_FIELD_NUMBER;
      hash = (53 * hash) + getWarningForceInfosList().hashCode();
    }
    if (hasWarningStartX()) {
  ...
  public static pb4client.WarningInfo parseFrom(
  ...
  public static pb4client.WarningInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static pb4client.WarningInfo parseFrom(
  ...
  public static pb4client.WarningInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static pb4client.WarningInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static pb4client.WarningInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(pb4client.WarningInfo prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:client2server.WarningInfo)
      pb4client.WarningInfoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pb4client.War2GamePkt.internal_static_client2server_WarningInfo_descriptor;
    }
    ...
    // Construct using pb4client.WarningInfo.newBuilder()
    private Builder() {
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessageV3
        ...
        getWarningForceInfosFieldBuilder();
      }
    }
    public Builder clear() {
      super.clear();
      if (warningForceInfosBuilder_ == null) {
        warningForceInfos_ = java.util.Collections.emptyList();
        bitField0_ = (bitField0_ & ~0x00000001);
      } else {
        warningForceInfosBuilder_.clear();
      }
      warningStartX_ = 0;
    ...
    public pb4client.WarningInfo getDefaultInstanceForType() {
      return pb4client.WarningInfo.getDefaultInstance();
    }

    public pb4client.WarningInfo build() {
      pb4client.WarningInfo result = buildPartial();
    ...
    public pb4client.WarningInfo buildPartial() {
      pb4client.WarningInfo result = new pb4client.WarningInfo(this);
      ...
      if (warningForceInfosBuilder_ == null) {
        ...
        result.warningForceInfos_ = warningForceInfos_;
      } else {
        result.warningForceInfos_ = warningForceInfosBuilder_.build();
      }
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof pb4client.WarningInfo) {
        return mergeFrom((pb4client.WarningInfo)other);
      } else {
    ...
    public Builder mergeFrom(pb4client.WarningInfo other) {
      if (other == pb4client.WarningInfo.getDefaultInstance()) return this;
      if (warningForceInfosBuilder_ == null) {
        if (!other.warningForceInfos_.isEmpty()) {
          if (warningForceInfos_.isEmpty()) {
            warningForceInfos_ = other.warningForceInfos_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureWarningForceInfosIsMutable();
            warningForceInfos_.addAll(other.warningForceInfos_);
          }
          onChanged();
        }
      } else {
        if (!other.warningForceInfos_.isEmpty()) {
          if (warningForceInfosBuilder_.isEmpty()) {
            warningForceInfosBuilder_.dispose();
            warningForceInfosBuilder_ = null;
            warningForceInfos_ = other.warningForceInfos_;
            bitField0_ = (bitField0_ & ~0x00000001);
            warningForceInfosBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getWarningForceInfosFieldBuilder() : null;
          } else {
            warningForceInfosBuilder_.addAllMessages(other.warningForceInfos_);
          }
        }
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      pb4client.WarningInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (pb4client.WarningInfo) e.getUnfinishedMessage();
    ...
    private void ensureWarningForceInfosIsMutable() {
      if (!((bitField0_ & 0x00000001) == 0x00000001)) {
        warningForceInfos_ = new java.util.ArrayList<pb4client.WalkForceInfo>(warningForceInfos_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        pb4client.WalkForceInfo, pb4client.WalkForceInfo.Builder, pb4client.WalkForceInfoOrBuilder> warningForceInfosBuilder_;
    ...
    public java.util.List<pb4client.WalkForceInfo> getWarningForceInfosList() {
      if (warningForceInfosBuilder_ == null) {
        return java.util.Collections.unmodifiableList(warningForceInfos_);
      } else {
        return warningForceInfosBuilder_.getMessageList();
      }
    }
    /**
     * <pre>
    ...
    public int getWarningForceInfosCount() {
      if (warningForceInfosBuilder_ == null) {
        ...
        return warningForceInfosBuilder_.getCount();
      }
    }
    /**
     * <pre>
    ...
    public pb4client.WalkForceInfo getWarningForceInfos(int index) {
      if (warningForceInfosBuilder_ == null) {
        ...
        return warningForceInfosBuilder_.getMessage(index);
      }
    }
    /**
     * <pre>
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public Builder setWarningForceInfos(
      ...
      if (warningForceInfosBuilder_ == null) {
        ...
        ensureWarningForceInfosIsMutable();
        warningForceInfos_.set(index, value);
        onChanged();
      } else {
        warningForceInfosBuilder_.setMessage(index, value);
      }
      return this;
    }
    /**
    ...
    public Builder setWarningForceInfos(
      ...
      if (warningForceInfosBuilder_ == null) {
        ensureWarningForceInfosIsMutable();
        warningForceInfos_.set(index, builderForValue.build());
        onChanged();
      } else {
        warningForceInfosBuilder_.setMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public Builder addWarningForceInfos(pb4client.WalkForceInfo value) {
      if (warningForceInfosBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureWarningForceInfosIsMutable();
        warningForceInfos_.add(value);
        onChanged();
      } else {
        warningForceInfosBuilder_.addMessage(value);
      }
      return this;
    }
    /**
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public Builder addWarningForceInfos(
        int index, pb4client.WalkForceInfo value) {
      if (warningForceInfosBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        ...
        ensureWarningForceInfosIsMutable();
        warningForceInfos_.add(index, value);
        onChanged();
      } else {
        warningForceInfosBuilder_.addMessage(index, value);
      }
      return this;
    }
    /**
    ...
    public Builder addWarningForceInfos(
      ...
      if (warningForceInfosBuilder_ == null) {
        ensureWarningForceInfosIsMutable();
        warningForceInfos_.add(builderForValue.build());
        onChanged();
      } else {
        warningForceInfosBuilder_.addMessage(builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addWarningForceInfos(
      ...
      if (warningForceInfosBuilder_ == null) {
        ensureWarningForceInfosIsMutable();
        warningForceInfos_.add(index, builderForValue.build());
        onChanged();
      } else {
        warningForceInfosBuilder_.addMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public Builder addAllWarningForceInfos(
        java.lang.Iterable<? extends pb4client.WalkForceInfo> values) {
      if (warningForceInfosBuilder_ == null) {
        ensureWarningForceInfosIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, warningForceInfos_);
        onChanged();
      } else {
        warningForceInfosBuilder_.addAllMessages(values);
      }
      return this;
    }
    /**
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public Builder clearWarningForceInfos() {
      if (warningForceInfosBuilder_ == null) {
        warningForceInfos_ = java.util.Collections.emptyList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public Builder removeWarningForceInfos(int index) {
      if (warningForceInfosBuilder_ == null) {
        ensureWarningForceInfosIsMutable();
        warningForceInfos_.remove(index);
        onChanged();
      } else {
        warningForceInfosBuilder_.remove(index);
      }
      return this;
    }
    /**
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public pb4client.WalkForceInfo.Builder getWarningForceInfosBuilder(
        int index) {
      return getWarningForceInfosFieldBuilder().getBuilder(index);
    }
    /**
     * <pre>
     * 进攻者ID
    ...
    public pb4client.WalkForceInfoOrBuilder getWarningForceInfosOrBuilder(
        int index) {
      if (warningForceInfosBuilder_ == null) {
        return warningForceInfos_.get(index);  } else {
        return warningForceInfosBuilder_.getMessageOrBuilder(index);
      }
    }
    /**
     * <pre>
    ...
    public java.util.List<? extends pb4client.WalkForceInfoOrBuilder> 
         getWarningForceInfosOrBuilderList() {
      if (warningForceInfosBuilder_ != null) {
        return warningForceInfosBuilder_.getMessageOrBuilderList();
      } else {
        return java.util.Collections.unmodifiableList(warningForceInfos_);
      }
    }
     ...
     * <code>repeated .client2server.WalkForceInfo warningForceInfos = 1;</code>
     */
    public pb4client.WalkForceInfo.Builder addWarningForceInfosBuilder() {
      return getWarningForceInfosFieldBuilder().addBuilder(
    ...
    public java.util.List<pb4client.WalkForceInfo.Builder> 
         getWarningForceInfosBuilderList() {
      return getWarningForceInfosFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        pb4client.WalkForceInfo, pb4client.WalkForceInfo.Builder, pb4client.WalkForceInfoOrBuilder> 
        getWarningForceInfosFieldBuilder() {
      if (warningForceInfosBuilder_ == null) {
        warningForceInfosBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            pb4client.WalkForceInfo, pb4client.WalkForceInfo.Builder, pb4client.WalkForceInfoOrBuilder>(
                warningForceInfos_,
                ((bitField0_ & 0x00000001) == 0x00000001),
                getParentForChildren(),
                isClean());
        warningForceInfos_ = null;
      }
      return warningForceInfosBuilder_;
    }
    ...
    // @@protoc_insertion_point(builder_scope:client2server.WarningInfo)
  }

  // @@protoc_insertion_point(class_scope:client2server.WarningInfo)
  private static final pb4client.WarningInfo DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new pb4client.WarningInfo();
  }

  public static pb4client.WarningInfo getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  @java.lang.Deprecated public static final com.google.protobuf.Parser<WarningInfo>
